...
export default function App() {
  ...
  return (
    <div className="app-container">
        ...
        <div className="landing-wrapper">
          ...
          <div className="hero-section">
            ...
            <h1 className="hero-title">
              Autonomous AI Auditor for <br />
              <span className="gradient-text">Decentralized DAO Payrolls</span>
            </h1>

            <p className="hero-description">
              Eliminate corporate fluff, meeting spam, and fake work in Web3 organizations. DAOGuillotine locks contributor bounties in escrow and uses consensus-driven AI nodes to evaluate proof-of-work before disbursing funds.
            </p>

            <div className="hero-cta-group">
              <button onClick={() => setActiveTab('CREATE_PAYROLL')} className="btn-primary" style={{ width: 'auto', padding: '16px 36px', fontSize: '16px' }}>
                Launch App & Lock Bounty
                <ArrowRight size={18} />
              </button>

              <button onClick={() => { setActiveTab('CABINET'); fetchPayrollsState(); }} className="btn-secondary">
                <FolderOpen size={18} />
            ...
            <div className="hero-stats">
              <div className="hero-stat-item">
                <div className="hero-stat-num">{payrolls.length}</div>
                <div className="hero-stat-lbl">Total Payroll Escrows</div>
              </div>
              <div className="hero-stat-divider" />
              <div className="hero-stat-item">
                <div className="hero-stat-num" style={{ color: 'var(--primary-cyan)' }}>{formatGen(contractBalance)} GEN</div>
                <div className="hero-stat-lbl">Active Contract Escrow</div>
              </div>
              <div className="hero-stat-divider" />
              <div className="hero-stat-item">
                <div className="hero-stat-num" style={{ color: 'var(--emerald-success)' }}>{paidCount}</div>
                <div className="hero-stat-lbl">Audited & Disbursed</div>
              </div>
              <div className="hero-stat-divider" />
              <div className="hero-stat-item">
                <div className="hero-stat-num" style={{ color: 'var(--rose-slash)' }}>{slashedCount}</div>
                <div className="hero-stat-lbl">Slashed & Refunded</div>
              </div>
            </div>
          </div>
          ...
          <div className="features-grid">
            <div className="feature-card">
              ...
              <h3 className="feature-title">On-Chain Web Scraping</h3>
              <p className="feature-text">
                GenLayer AI nodes fetch live public deliverables (GitHub PRs, Notion Docs, Blog Reports) natively via <code className="code-tag">gl.nondet.web.render</code> without relying on centralized Web2 oracles.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <h3 className="feature-title">AI Tech Lead Auditor</h3>
              <p className="feature-text">
                An impartial LLM prompt audits report text, calculating an Effort Score (0-100%). Scores $\ge$ 50% release salary to the contributor; fluff & meeting spam trigger total refund.
              </p>
            </div>
            ...
            <div className="feature-card">
              ...
              <h3 className="feature-title">Fail-Closed Consensus</h3>
              <p className="feature-text">
                Validator nodes independently rerun web scraping and LLM audit. Any scrape or parsing failure forces <code className="code-tag">validator_fn</code> to return False, keeping escrow funds locked safely.
              </p>
            </div>
          </div>
          ...
          <div className="how-it-works-panel">
            <h2 className="section-heading">How DAOGuillotine Protocol Works</h2>
            <p className="section-sub">A 3-step autonomous workflow for transparent DAO bounty management</p>

            <div className="steps-container">
              <div className="step-box">
                <div className="step-number">01</div>
                <h4 className="step-title">Lock Bounty Escrow</h4>
                <p className="step-desc">DAO Admin deposits native GEN tokens into <code className="code-tag">create_payroll</code>, locking funds in escrow for a designated developer address.</p>
              </div>

              <div className="step-box">
                <div className="step-number">02</div>
                <h4 className="step-title">Submit Deliverable URL</h4>
                <p className="step-desc">Before payday, the contributor submits a link to their work report. GenLayer AI nodes scrape and audit deliverables against corporate fluff.</p>
              </div>

              <div className="step-box">
                <div className="step-number">03</div>
                <h4 className="step-title">Autonomous Settlement</h4>
                <p className="step-desc">Upon validator consensus, funds auto-payout to the contributor if approved, or refund 100% back to the DAO treasury if slashed.</p>
              </div>
            </div>
          </div>
        </div>
      ...
      {/* WORKSPACE TAB: CREATE_PAYROLL or CABINET */}
      {activeTab !== 'LANDING' && (
        <main>
          {/* Stats Overview Bar */}
              ...
              {payrolls.length === 0 ? (
                <div className="glass-panel" style={{ textAlign: 'center', padding: '60px 20px' }}>
                  ...
                  <p style={{ color: 'var(--text-muted)', fontSize: '14px', marginBottom: '24px' }}>
                    Create your first payroll bounty in the "Lock Bounty" tab.
                  </p>
